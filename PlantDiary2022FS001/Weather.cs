...
namespace PlantPlacesWeather
{
    ...
    public partial class Weather
    {
        public static Weather FromJson(string json) => JsonConvert.DeserializeObject<Weather>(json, PlantPlacesWeather.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this Weather self) => JsonConvert.SerializeObject(self, PlantPlacesWeather.Converter.Settings);
    }
